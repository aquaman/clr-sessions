...
table header goes here
    <th width="7%"><font face="Arial"><a href="cov_by_num_bugs.htm"># BUGS</a></font></th>
    <th width="8%"><font face="Arial"><a href="cov_by_num_issues.htm"># ISSUES</a></font></th>
    <th width="40%"><font face="Arial"><a href="cov_by_area.htm">AREA</a></font></th>
  </tr>
...
<dl>
  ...
  <h3><a name="total"></a><font face="Arial">TOTAL = <i>total amount of associated
    session work</i></font></h3></dt>

  <dd>The total amount of session work, expressed in normal sessions, that is
    ...
    totals from different areas may well have sessions in common.
  </dd>
  ...
  <dd>The amount of session work that was <i>not</i> within the charter of each
    ...
    one may be distracting the testers. CHTR + OPP = TOTAL
  </dd>
  ...
  <dd>The amount of on-charter work that was devoted to searching for bugs. The
    ...
    testing in one area may not have the same value as 10 sessions in another.
    (% TEST) + (% BUG) + (% SETUP) = CHTR.
  </dd>
  ...
  <dd>The amount of on-charter work that was devoted to anything other than bug
    ...
    test project is still getting up to speed. (% TEST) + (% BUG) + (% SETUP) = CHTR.
  </dd>

  <dt>
  <h3><a name="num_bugs"></a><font face="Arial"># BUGS = <i>total number of bugs found
    in sessions associated with this coverage area</i></font></h3></dt>

  <dd>The total number of bugs reported to the test lead that are associated with
    ...
    indicates either a weak area of the product, or an area that confuses the testers.
  </dd>

  <dt>
  <h3><a name="num_issues"></a><font face="Arial"># ISSUES = <i>total number of issues
    found in sessions associated with this coverage area</i></font></h3></dt>

  <dd>The total number of issues reported in sessions associated with the coverage
    area. A high ratio of (# ISSUES) to CHTR generally indicates a testability problem
    in that area.
  </dd>

  <dt>
  <h3><a name="area"></a><font face="Arial">AREA = <i>coverage area</i></font></h3></dt>

  <dd>The coverage area to which the metrics apply. What we call &quot;coverage
